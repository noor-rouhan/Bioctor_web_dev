            ...
            <div class="modal-dialog" role="document">
                <div class="card card-shadowed p-50 w-400 mb-0" style="max-width: 100%">
                    ...
                    <br><br>
                        ...
                        <ul class="list-group alert alert-danger" v-if="error.length > 0">
            ...
            attemptLogin(){
                ...
                axios.post('/login',{
                    ...
                    if(error.response.status == 422){
                        this.error.push("Your email or password is incorrect.")
                    }else{
                        this.error.push("Something going wrong, please try again.");
                    }
                })

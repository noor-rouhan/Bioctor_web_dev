    ...
    <div class="row gap-y">
      <div class="col-12">
        ...
        <form action="" method="POST">
          ...
          {{-- 'patient_name', 'age', 'sex', 'case_title','case_des','blood_group' --}}

          <div class="form-group">
            <textarea class="form-control form-control-lg" type="text" name="sex"  placeholder="Your Message"></textarea>
          </div>

          <div class="form-group">
            <textarea class="form-control form-control-lg" type="text" name="case_title"  placeholder="Your Message"></textarea>
          </div>

          <div class="form-group">
            <textarea class="form-control form-control-lg" type="text" name="case_des"  placeholder="Your Message"></textarea>
          </div>
